...
class ColorSniper:
    ...
    def update_ammo_ui(self):
        for i, hex_code in enumerate(self.color_history):
            try:
                ...
                if os.path.exists("python\\colorPicker\\ColorSniper\\ammo.png"):
                    ammo_img_main = Image.open("python\\colorPicker\\ColorSniper\\ammo.png").convert("RGBA").resize((20, 38), Image.Resampling.NEAREST)
                    ammo_img_overlay = Image.open("python\\colorPicker\\ColorSniper\\ammo.png").convert("RGBA").resize((26, 50), Image.Resampling.NEAREST)
    ...
    def show_shoot_effect(self, x, y, hex_color):
        ...
        try:
            base_img = Image.open("python\\colorPicker\\ColorSniper\\shoot.png").convert("RGBA").resize((120, 120), Image.Resampling.NEAREST)
